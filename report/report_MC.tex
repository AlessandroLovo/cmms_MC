...
\section{Introduction}
  ...
  \section{Choice of the simulation parameters}
    ...
    \subsection{How many spins to pick}
      First of all one should notice that picking together $n > 1$ spins is incompatible with the cycling technique as the $n$-uples of spins will periodically repeat somehow partitioning the system in groups. And actually in this case the system does not evolve at all.
  ...
  \section{Results of the simulations}
    ...
    \begin{figure}[H]
      ...
      \resizebox{0.45\textwidth}{!}{\import{img/}{D2_chi_free.pgf}}
    ...
    \begin{figure}[H]
      ...
      \begin{subfigure}[Fit of the magnetization with respect to $k$ at $h = 0$]{
        \resizebox{0.45\textwidth}{!}{\import{img/}{D2_N64_beta.pgf}}
        \label{fig:D2_beta}}
      \end{subfigure}
      \begin{subfigure}[Fit of the magnetic susceptibility]{
        \resizebox{0.45\textwidth}{!}{\import{img/}{D2_N64_gamma.pgf}}
        \label{fig:D2_gamma}}
      \end{subfigure} \\
      \begin{subfigure}[Fit of the specific heat]{
        \resizebox{0.45\textwidth}{!}{\import{img/}{D2_N64_alpha.pgf}}
        \label{fig:D2_alpha}}
      \end{subfigure}
      \begin{subfigure}[Fit of the magnetization with respect to $h$ at $k = k_c$]{
        \resizebox{0.45\textwidth}{!}{\import{img/}{D2_N64_delta.pgf}}
        \label{fig:D2_delta}}
      \end{subfigure}
  ...
  \subsection{Comparison with higher dimensions}
    ...
    \begin{figure}[H]
      ...
      \begin{subfigure}[Solid $\gamma_1$, dotted $\gamma_2$]{
        \resizebox{0.47\textwidth}{!}{\import{img/}{gammas.pgf}}
        \label{fig:gammas}}
      \end{subfigure}
      \begin{subfigure}[]{
